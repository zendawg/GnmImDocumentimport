...
class GnmImDocumentimportModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'GnmImDocumentimport.models.*',
			'GnmImDocumentimport.components.*',
		));

		$this->moduleShortSuffix = "documentimport";
	}
